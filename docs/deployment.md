...
Create a file at `.env.local` in the project root. This file replaces `terraform.tfvars` and centralizes your config.
...
3.  **Initialize**: Run `terraform init` in the main `/terraform` directory to migrate state to S3.
