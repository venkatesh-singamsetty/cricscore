...
**Base URL**: `https://<api-id>.execute-api.us-east-1.amazonaws.com` (Dynamically injected as `VITE_API_URL` by `deploy.sh`)
...
**URL**: `wss://<ws-id>.execute-api.us-east-1.amazonaws.com/prod` (Dynamically injected as `VITE_WS_URL` by `deploy.sh`)
