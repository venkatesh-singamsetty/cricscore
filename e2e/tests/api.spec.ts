...
test.describe('CricScore API Integration Tests', () => {
  test('should return successful response for OPTIONS request on /matches', async ({ request }) => {
  ...
  test('should return 404 for a non-existent match details', async ({ request }) => {
    // Must use valid UUID format so Postgres doesn't throw a 500 error
    const response = await request.get(`${API_URL}/match/00000000-0000-0000-0000-000000000000/details`);
